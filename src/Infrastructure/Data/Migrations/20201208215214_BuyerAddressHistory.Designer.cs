...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20201208215214_BuyerAddressHistory")]
    partial class BuyerAddressHistory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.BuyerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.BuyerAddressHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("BuyerAddressHistories");
                });
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.BuyerAddress", b =>
                {
                    ...
                    b.OwnsOne("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.Address", "Address", b1 =>
                        {
                            b1.Property<int>("BuyerAddressId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .UseIdentityColumn();
                            ...
                            b1.HasKey("BuyerAddressId");

                            b1.ToTable("BuyerAddress");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.BuyerAddressHistory", b =>
                {
                    b.OwnsOne("Microsoft.eShopWeb.ApplicationCore.Entities.BuyerAggregate.Address", "PreviousAddress", b1 =>
                        {
                            b1.Property<int>("BuyerAddressHistoryId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                                .UseIdentityColumn();
                            ...
                            b1.HasKey("BuyerAddressHistoryId");

                            b1.ToTable("BuyerAddressHistories");

                            b1.WithOwner()
                                .HasForeignKey("BuyerAddressHistoryId");
                        });
